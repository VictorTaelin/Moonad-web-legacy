...
var term = string_to_term(test);
console.log(term.to_string(new Context([])));
console.log(term.check(new Context([])).to_string(new Context([])));
console.log(term.eval(true).to_string(new Context([])));
